                ...
                <div class="row heading">
                    <div class="col-sm-3 col-xs-3 heading-avatar">
                        <div class="heading-avatar-icon">
                            <img src="${sessionScope.account.getUser().getAvatar()}">
                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-4   col-lg-pull-0">
                        <p class="heading-userDisplayName">${sessionScope.account.getUser().getUdisplayname()}</p>
                        <p class="heading-userName">${sessionScope.account.getUser().getUname()}</p>
                    </div>
                        ...
                        <div class="row sideBar-body">
                            <div class="col-sm-3 col-xs-3 sideBar-avatar">
                                <div class="avatar-icon">
                                    <img src="${c.getFriend_user().getAvatar()}">
                                </div>
                            </div>
                            <div class="col-sm-9 col-xs-9 sideBar-main">
                                <div class="row">
                                    <div class="col-sm-8 col-xs-8 sideBar-name">
                                        <span class="name-meta"> ${c.getFriend_user().getUdisplayname()} </span>
                                        <br>
                                        <span class="mess-meta"> ${c.getLastMess()} </span>
                                    </div>
                                    <div class="col-sm-4 col-xs-4 pull-right sideBar-time">
                                        <span class="time-meta pull-right">
                                          <c:choose>
                                              <c:when test="${not empty c.getMessage().getRead_at()}"> ${c.getMessage().getRead_at_String()} </c:when>
                                              <c:otherwise> ${c.getMessage().getCreate_at_String()} </c:otherwise>
                                          </c:choose>
                                        </span>
                                    </div>
                                </div>
